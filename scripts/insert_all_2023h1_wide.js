/*
  Bulk insert all employees' 2023 H1 (202301-202306) wide-calculation rows
  into calculate_result_2023_h1_wide, for employees who have salary
  records in 2023 H1 (salary_month_std between '202301' and '202306').

  Usage:
    node scripts/insert_all_2023h1_wide.js
*/
...
async function main() {
  ...
  console.log('🚀 Bulk insert 2023 H1 wide for employees with H1 salary records')
  ...
  for (const empId of empIds) {
    ...
    const refBase = round2(hireYear < 2022 ? (Number(b.avg_wage_wide_2022) || 0) : (Number(b.first_month_base_wide) || 0))
