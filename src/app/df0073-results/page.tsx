...
export default function DF0073ResultsPage() {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">正在加载DF-0073员工计算结果...</p>
        </div>
      </div>
    )
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            A类老员工算法验证 - 宽口径假设 - 共{totalRecords}条记录
          </p>
        </div>
        ...
        <div className="mt-8 bg-white shadow-sm border border-gray-200 rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <p className="text-gray-600">DF-0073于2007年入职，在所有计算期间均为A类老员工</p>
            </div>
            <div>
              <h4 className="font-medium text-gray-900 mb-2">参考工资切换验证</h4>
              <p className="text-gray-600">
                2023年1月-2024年6月使用2022年平均工资¥8,702.02<br/>
                2024年7月-9月切换至2023年平均工资¥9,607.99
              </p>
            </div>
            <div>
              <h4 className="font-medium text-gray-900 mb-2">分险种基数调整</h4>
              <p className="text-gray-600">医疗保险基数在某些期间受限制调整，其他险种按标准调整</p>
            </div>
            <div>
              <h4 className="font-medium text-gray-900 mb-2">缴费总额变化</h4>
              <p className="text-gray-600">
                2023年H1: ¥1,943.10 (医疗保险比例较低)<br/>
                2023年H2-2024年H1: ¥2,172.02 (医疗保险比例调整)<br/>
                2024年H2: ¥2,298.98 (参考工资提升)
              </p>
            </div>
          </div>
        </div>
