...
export default function DF3762ResultsPage() {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">正在加载DF-3762员工计算结果...</p>
        </div>
      </div>
    )
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            三阶段员工分类算法验证 (C类→B类→A类) - 宽口径假设 - 共{totalRecords}条记录
          </p>
        </div>
                        ...
                        <tr key={record.id} className="hover:bg-gray-50">
                          ...
                          <td className="px-3 py-3 whitespace-nowrap border-r">
                            <span className={`inline-flex px-2 py-1 text-xs font-medium rounded-full ${
                              record.employee_category === 'C' ? 'bg-purple-100 text-purple-800' :
                              record.employee_category === 'B' ? 'bg-green-100 text-green-800' :
        ...
        <div className="mt-8 bg-white shadow-sm border border-gray-200 rounded-lg p-6">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">三阶段员工分类算法验证</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            <div>
              <h4 className="font-medium text-gray-900 mb-2">分类阶段1: C类 (2023年H1)</h4>
              <p className="text-gray-600">2023年3月入职，在2023年H1期间属于"下一社保年度新员工"</p>
            </div>
            <div>
              <h4 className="font-medium text-gray-900 mb-2">分类阶段2: B类 (2023年H2-2024年H1)</h4>
              <p className="text-gray-600">从2023年7月起变为"当前社保年度新员工"</p>
            </div>
            <div>
              <h4 className="font-medium text-gray-900 mb-2">分类阶段3: A类 (2024年H2)</h4>
              <p className="text-gray-600">从2024年7月起变为"老员工"，参考工资切换为2023年平均工资</p>
            </div>
            <div>
              <h4 className="font-medium text-gray-900 mb-2">参考工资逻辑验证</h4>
              <p className="text-gray-600">
                C/B类期间使用入职首月工资¥4,171.82<br/>
                A类期间切换为2023年平均工资¥5,277.11
              </p>
            </div>
          </div>
        </div>
