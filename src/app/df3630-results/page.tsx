...
export default function DF3630ResultsPage() {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">正在加载DF-3630员工计算结果...</p>
        </div>
      </div>
    )
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 bg-white shadow-sm border border-gray-200 rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            <div>
              <h4 className="font-medium text-gray-900 mb-2">员工分类 (B类→A类动态切换)</h4>
              <p className="text-gray-600">DF-3630于2022年入职，2023年H1为B类新员工，2023年H2起变为A类老员工</p>
            </div>
            <div>
              <h4 className="font-medium text-gray-900 mb-2">参考工资切换</h4>
              <p className="text-gray-600">
                2023年1月-6月使用入职首月工资¥4,666.44 (B类逻辑)<br/>
                2023年7月-2024年6月使用2022年平均工资¥5,402.56 (A类逻辑)<br/>
                2024年7月-9月切换至2023年平均工资¥6,035.09 (A类逻辑)
              </p>
            </div>
            <div>
              <h4 className="font-medium text-gray-900 mb-2">基数调整逻辑</h4>
              <p className="text-gray-600">各险种按相应基数上下限调整，工伤保险不调整直接使用参考工资</p>
            </div>
            <div>
              <h4 className="font-medium text-gray-900 mb-2">缴费总额变化趋势</h4>
              <p className="text-gray-600">
                B类期间相对较低，转为A类后随参考工资上涨而增加，体现分类算法的准确性
              </p>
            </div>
          </div>
        </div>
